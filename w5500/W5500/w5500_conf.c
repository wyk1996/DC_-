...
/*定义默认IP信息*/
uint8 local_ip[4]={192,168,6,170};												/*定义W5500默认IP地址*/
...
/*定义远端IP信息*/
//uint8  remote_ip[4]={122,114,122,174};										/*远端IP地址*/
//uint16 remote_port=41625;																/*远端端口号*/

uint8  remote_ip[4]={192,168,6,189};										/*远端IP地址*/
