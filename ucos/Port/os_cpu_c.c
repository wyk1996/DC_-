...
//       p_stk      = ptos;                                                          /* Align the stack to 8-bytes.                          */
//    p_stk      = (OS_STK *)((OS_STK)(p_stk) & 0xFFFFFFF8u);
//    
////    //FPU
////    *(--p_stk) = (OS_STK)0x00001000L; //FPSCR
////	*(--p_stk) = (OS_STK)0x00000015L; //s15
////	*(--p_stk) = (OS_STK)0x00000014L; //s14
////	*(--p_stk) = (OS_STK)0x00000013L; //s13
////	*(--p_stk) = (OS_STK)0x00000012L; //s12
////	*(--p_stk) = (OS_STK)0x00000011L; //s11
////	*(--p_stk) = (OS_STK)0x00000010L; //s10
////	*(--p_stk) = (OS_STK)0x00000009L; //s9
////	*(--p_stk) = (OS_STK)0x00000008L; //s8
////	*(--p_stk) = (OS_STK)0x00000007L; //s7
////	*(--p_stk) = (OS_STK)0x00000006L; //s6
////	*(--p_stk) = (OS_STK)0x00000005L; //s5
////	*(--p_stk) = (OS_STK)0x00000004L; //s4
////	*(--p_stk) = (OS_STK)0x00000003L; //s3
////	*(--p_stk) = (OS_STK)0x00000002L; //s2
////	*(--p_stk) = (OS_STK)0x00000001L; //s1
////	*(--p_stk) = (OS_STK)0x00000000L; //s0	
...
//////FPU
////	*(--p_stk) = (OS_STK)0x00000031L; //s31
////	*(--p_stk) = (OS_STK)0x00000030L; //s30
////	*(--p_stk) = (OS_STK)0x00000029L; //s29
////	*(--p_stk) = (OS_STK)0x00000028L; //s28
////	*(--p_stk) = (OS_STK)0x00000027L; //s27
////	*(--p_stk) = (OS_STK)0x00000026L; //s26	
////	*(--p_stk) = (OS_STK)0x00000025L; //s25
////	*(--p_stk) = (OS_STK)0x00000024L; //s24
////	*(--p_stk) = (OS_STK)0x00000023L; //s23
////	*(--p_stk) = (OS_STK)0x00000022L; //s22
////	*(--p_stk) = (OS_STK)0x00000021L; //s21
////	*(--p_stk) = (OS_STK)0x00000020L; //s20
////	*(--p_stk) = (OS_STK)0x00000019L; //s19
////	*(--p_stk) = (OS_STK)0x00000018L; //s18
////	*(--p_stk) = (OS_STK)0x00000017L; //s17
////	*(--p_stk) = (OS_STK)0x00000016L; //s16
...
//    p_stk      = ptos + 1u;                                     /* Load stack pointer                                   */
    p_stk      = ptos;                                          /* Load stack pointer                                   */
        ...
        *--p_stk = 0x00000000u;                        /* 没有名字的寄存器，就固定填充的                                        */
        *--p_stk = 0x00001000u;                        /* FPSCR                                                  */
                                                                /* Initialize S15-S0 floating point registers             */
